...
@section('content')
    <form action="{{ route('dashboard.customer-services.update', $customerService->id) }}" method="POST" enctype="multipart/form-data" class="card shadow-sm">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 mb-7 d-flex justify-content-center align-items-center flex-column">
                    ...
                    <div class="image-input d-flex flex-column">
                        <a data-fslightbox="profile" href="{{ $customerService->profile }}" class="symbol symbol-150px my-3 bg-white border border-5 border-white rounded-4 shadow-sm overflow-hidden">
                ...
                <div class="col-md-6 mb-7">
                    ...
                    <input name="name" value="{{ old('name', $customerService->name) }}" type="text" class="form-control mt-3 @error('name') is-invalid @enderror">
                    @error('name')
                ...
                <div class="col-md-6 mb-7">
                    ...
                    <input name="email" value="{{ old('email', $customerService->email) }}" type="text" class="form-control mt-3 @error('email') is-invalid @enderror">
                    @error('email')
                        <span class="invalid-feedback d-flex text-capitalize">{{ $message }}</span>
                    @enderror
                </div>
...
@push('js')
    ...
    <script>
        ...
        // SELECT
        $('[name="role"]').select2().val('{{ old('role', $customerService->roleId) }}');
    </script>
@endpush
