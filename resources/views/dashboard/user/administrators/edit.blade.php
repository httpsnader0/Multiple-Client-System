...
@section('content')
    <form action="{{ route('dashboard.administrators.update', $administrator->id) }}" method="POST" enctype="multipart/form-data" class="card shadow-sm">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 mb-7 d-flex justify-content-center align-items-center flex-column">
                    ...
                    <div class="image-input d-flex flex-column">
                        <a data-fslightbox="profile" href="{{ $administrator->profile }}" class="symbol symbol-150px my-3 bg-white border border-5 border-white rounded-4 shadow-sm overflow-hidden">
                ...
                <div class="col-md-6 mb-7">
                    ...
                    <input name="name" value="{{ old('name', $administrator->name) }}" type="text" class="form-control mt-3 @error('name') is-invalid @enderror">
                    @error('name')
                ...
                <div class="col-md-6 mb-7">
                    ...
                    <input name="phone" value="{{ old('phone', $administrator->phone) }}" type="text" class="form-control mt-3 @error('phone') is-invalid @enderror">
                    @error('phone')
                        <span class="invalid-feedback d-flex text-capitalize">{{ $message }}</span>
                    @enderror
                </div>
