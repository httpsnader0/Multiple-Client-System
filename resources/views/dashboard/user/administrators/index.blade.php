...
@section('actions')
    ...
    <a href="{{ route('dashboard.administrators.create') }}" class="btn btn-danger d-flex align-items-center gap-2 w-100 w-md-auto justify-content-center order-1 order-md-3">
