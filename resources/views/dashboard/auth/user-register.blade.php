...
@section('content')
    <form action="{{ route('dashboard.user-register.store') }}" method="POST" class="row justify-content-center">
        @csrf
        <div class="col-md-12 text-center mb-10">
            <h1 class="fw-bolder text-danger mb-3 fs-3x">@lang('User Register')</h1>
