...
@section('content')
    <form action="{{ route('dashboard.products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="card shadow-sm">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 mb-7 d-flex justify-content-center align-items-center flex-column">
                    ...
                    <div class="image-input d-flex flex-column">
                        <a data-fslightbox="cover" href="{{ $product->cover }}" class="symbol symbol-150px my-3 bg-white border border-5 border-white rounded-4 shadow-sm overflow-hidden">
                                        ...
                                        <div class="accordion-body px-7 pt-7 pb-0">
                                            <div class="row justify-content-center">
                                                <div class="col-md-12 mb-7">
                                                    ...
                                                    <input name="name[{{ $localeCode }}]" value="{{ old('name.' . $localeCode, $product->getTranslation('name', $localeCode)) }}" type="text" class="form-control mt-3 @error('name.' . $localeCode) is-invalid @enderror">
                                                ...
                                                <div class="col-md-12 mb-7">
                                                    ...
                                                    <input name="description[{{ $localeCode }}]" value="{{ old('description.' . $localeCode, $product->getTranslation('description', $localeCode)) }}" type="text" class="form-control mt-3 @error('description.' . $localeCode) is-invalid @enderror">
                ...
                <div class="col-md-12 mb-7">
                    ...
                    <input name="price" value="{{ old('price', $product->price) }}" type="number" min="0.1" step="0.1" class="form-control mt-3 no-number-arrow @error('price') is-invalid @enderror">
                    @error('price')
                        <span class="invalid-feedback d-flex text-capitalize">{{ $message }}</span>
                    @enderror
                </div>
